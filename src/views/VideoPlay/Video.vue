    ...
    <div>
        ...
        <div class="play_video_message play_video_message_center_horizontally">
            ...
            <div class="play_video_message_center_horizontally">
                ...
                <div @click="ifShowBullet">
                    <svg v-if="!if_show_bullet" viewBox="0 0 1186 1024" width="40" height="40"
                    ...
                    <svg v-if="if_show_bullet" viewBox="0 0 1186 1024" version="1.1"
                         class="play_video_message_svg "
                         width="40" height="40">
                        <title>弹屏</title>
                        <path
...
export default {
    ...
    methods: {
        handleTimeUpdate() {
            ...
            const percent = (currentTime / duration) * 100; // 当前播放进度，百分比
            // 更新进度条宽度
            this.progressWidth = `${percent}%`;
            this.currentTime = new Date(currentTime * 1000).toISOString().substr(11, 8);
        ...
        ifShowBullet() {
            ...
            if (this.if_show_bullet) {
                ...
                // 更新全局透明度
                // this.CM.setConfig({ opacity: 0 });
                this.CM.goto(0)
                // 用于暂停动画
                this.CM.pause()
                console.log("关闭弹幕", this.CM.animState)
            }
        },
        menuPlay() {
